    ...
    for (auto nodeInfo : nodes) {
        for (unsigned i = 0; i < nodeInfo.node->mNumMeshes; ++i) {
            ...
            collisionObject->AddPrimitive<const char*>(isTransparent ?
                "COLLISION_LAYERS_STATIC | COLLISION_LAYERS_BLOCK_BALL | COLLISION_LAYERS_TANGIBLE | COLLISION_LAYERS_BLOCK_TURRET_SIGHT | COLLISION_LAYERS_TRANSPARENT" :
                "COLLISION_LAYERS_STATIC | COLLISION_LAYERS_BLOCK_BALL | COLLISION_LAYERS_TANGIBLE | COLLISION_LAYERS_BLOCK_TURRET_SIGHT");
