...
if (Blender_EXECUTABLE)
    ...
    if (NOT VERSION_COMMAND_RC EQUAL 0)
        message(FATAL_ERROR "Error getting Blender version: ${VERSION_COMMAND_ERROR}")
    elseif (NOT VERSION_COMMAND_OUTPUT MATCHES "^Blender ([0-9\\.]+)")
        message(FATAL_ERROR "Unexpected output getting Blender version:\n${VERSION_COMMAND_OUTPUT}")
    else()
